...
const downloadSpec = async () => {
  ...
  try {
    ...
    style.textContent = `
      .spec-row1 .spec-cert-row { width: auto !important; justify-content: flex-start !important; }
      .spec-cert-row { width: auto !important; justify-content: flex-start !important; }
